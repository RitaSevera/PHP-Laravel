...
Route::get('/tarefas', [tarefaController::class, 'allTarefa'])->name('tarefas');
Route::get('/tarefas/view{id}', [tarefaController::class, 'viewTasks'])->name('tarefa.view');
...
Route::get('/tarefas/add', [tarefaController::class, 'addTasks'])->name('tarefa.add');
